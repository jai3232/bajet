...
<div class="panel panel-default">
	<div class="panel-heading">
  	...
  	<div class="panel-body">
    	<div id="no"> No: <?= $model->kod_id ?> <br>(OS: <?= $model->kodUnjuran->os ?>) </div>
    	<h4>Maklumat Permohonan</h4>
		<table width="80%" align="center" class="table table-bordered bordered">
			<tbody>
    		...
    		<tbody>
    			<tr>
    				<td width="60%">
    					...
    					<table>
    						<tr><td class="bordered" width="40px"></td><td width="5px"></td><td> Mengurus (OS ___________ )</td></tr>
    						<tr><td class="bordered"></td><td></td><td> Amanah (Para ______________)</td></tr>
    						<tr><td class="bordered"></td><td></td><td> Pembangunan ( Kod Aktiviti __________ )</td></tr>
    						<tr><td class="bordered"></td><td></td><td>  Lain-Lain (sila nyatakan)________________</td></tr>
    					</table>
    				</td>
    				<td valign="top">
    		...
    		<tbody>
    			<tr>
    				<td width="60%">
    					...
    					<table>
    						<tr><td class="bordered" width="40px"></td><td width="5px"></td><td>Diluluskan</td></tr>
    						<tr><td class="bordered"></td><td></td><td>Tidak Diluluskan</td></tr>
    					</table>
    					<p>&nbsp;</p>
    					______________________________<br>
    					( Tandatangan dan cop jawatan)<br>
