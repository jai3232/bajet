					...
					<table width="100%" border="0" class="noborder">
						<tbody>
							<tr>
								...
								<td width="1%">(<span id="kadar_elaun1"><?= $model->peratus_elaun_makan * 100 ?></span>%)</td>
								<td width="33%">sehari di semananjung</td>
								<td width="8%" align="right" id="jumlah_elaun1"><?= number_format(($model->kali_makan * $model->peratus_elaun_makan * $model->elaun_makan), 2) ?></td>
							</tr>
							<tr>
								...
								<td>(<span id="kadar_elaun2"><?= $model->peratus_elaun_harian * 100 ?></span>%)</td>
								<td> sehari di semananjung</td>
								<td align="right" id="jumlah_elaun2"><?= number_format(($model->kali_harian * $model->peratus_elaun_harian * $model->elaun_harian), 2) ?></td>
							</tr>
							<tr>
								...
								<td>(<span id="kadar_elaun3"><?= $model->peratus_elaun_makan_sabah * 100 ?></span>%)</td>
								<td> sehari di Sabah / Sarawak</td>
								<td align="right" id="jumlah_elaun3"><?= number_format(($model->kali_makan_sabah * $model->peratus_elaun_makan_sabah * $model->elaun_makan_sabah), 2) ?></td>
							</tr>
							<tr>
								...
								<td>(<span id="kadar_elaun4"><?= $model->peratus_elaun_harian_sabah * 100 ?></span>%)</td>
								<td> sehari di Sabah / Sarawak</td>
								<td align="right" id="jumlah_elaun4"><?= number_format(($model->kali_harian_sabah * $model->peratus_elaun_harian_sabah * $model->elaun_harian_sabah), 2) ?></td>
							</tr>
							<tr>
								...
								<td>(<span id="kadar_elaun5"><?= $model->peratus_elaun_luar * 100 ?></span>%)</td>
								<td>sehari luar negara</td>
								<td align="right" id="jumlah_elaun5"><?= number_format(($model->kali_elaun_luar * $model->peratus_elaun_luar * $model->elaun_luar), 2) ?></td>
							</tr>
						</tbody>
					</table>
				</td>
