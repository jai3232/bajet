...
$this->title = 'Laporan Perbelanjaan '.$year;
...
// print_r($row_warans);
// echo '<br><br>';
// print_r($perbelanjaan_os);
?>
<div class="row">
	<!-- Perbelanjaan Mengikut OS 10000 - 30000 -->
	<div class="col-sm-6">
		<?php
			echo Highcharts::widget([
			    'options' => [
			        ...
			        'title' => ['text' => 'Perbelanjaan Mengikut OS 11000 - 30000 Tahun '.$year],
			        'plotOptions' => [
			            'pie' => [
			                'cursor' => 'pointer',
			                'dataLabels' => [
			                	'enabled' => true,
			                	'format' => '<b>{point.name}</b>: {point.y:,.2f} ({point.percentage:.1f} %)</b>',
			                	// 'style' => [
			        ...
			        'series' => [
			            [ // new opening bracket
			                'type' => 'pie',
			                'name' => 'RM',
			                'data' => $perbelanjaan_os1,//[[1, 2],[3, 4]],//$data,
			                // [
			                //     // ['Baki Agihan', 1000],
			                // ],
			            ] // new closing bracket
	...
	<!-- Perbelanjaan Mengikut OS 40000 +++ -->
	<div class="col-sm-6">
		<?php
			echo Highcharts::widget([
			    'options' => [
			        ...
			        'title' => ['text' => 'Perbelanjaan Mengikut OS 40000 - * Tahun '.$year],
			        'plotOptions' => [
			            'pie' => [
			                'cursor' => 'pointer',
			                'dataLabels' => [
			        ...
			        'series' => [
			            [ // new opening bracket
			                'type' => 'pie',
			                'name' => 'RM',
			                'data' => $perbelanjaan_os2,//[[1, 2],[3, 4]],//$data,
			                // [
			                //     // ['Baki Agihan', 1000],
			                // ],
			            ] // new closing bracket
...
<div id="perbelanjaan-agihan" style="min-width: 310px; max-width: 1600px; height: 700px; margin: 0 auto">
<?php
